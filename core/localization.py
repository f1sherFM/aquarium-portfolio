        ...
        "pages": {
            ...
            "projects": {
                ...
                "items": [
                    ...
                    {
                        "tag": "Web",
                        "meta": "Django / Analytics / Tracking",
                        "title": "Habit Tracker",
                        "description": "Веб-приложение для отслеживания привычек с продвинутыми функциями аналитики, категоризации и комментариев.",
                        "links": [
                            {"label": "GitHub", "url": "https://github.com/f1sherFM/Habit-Tracker"},
                            {"label": "Подробнее", "url": "https://github.com/f1sherFM/Habit-Tracker/blob/main/README.md"},
                        ],
                    },
                    {
                        "tag": "Course Project",
                        "meta": "FastAPI / Docker / Kubernetes",
                        "title": "Bookstore API Course",
                        "description": "Полный курс разработки на Python: FastAPI, Docker, Kubernetes, Alembic и DevOps. От основ до продакшена с 95% покрытием тестами.",
                        "links": [
                            {"label": "GitHub", "url": "https://github.com/f1sherFM/bookstore-api-course"},
                            {"label": "Подробнее", "url": "https://github.com/f1sherFM/bookstore-api-course/blob/main/README_RU.md"},
                        ],
                    },
                    {
                        "tag": "Library",
                        "meta": "Python / Validation / Files",
                        "title": "Fishertools",
                        "description": "Python-библиотека, которая помогает справляться с распространенными ошибками, проверять входные данные, безопасно работать с файлами и объяснять ошибки в доступной для начинающих форме.",
                        "links": [
                            {"label": "GitHub", "url": "https://github.com/f1sherFM/Fishertools"},
                            {"label": "Подробнее", "url": "https://github.com/f1sherFM/Fishertools/blob/main/README.md"},
                        ],
                    },
                    {
                        "tag": "Web",
                        ...
                        "description": "Персональный сайт-портфолио на Django с акцентом на backend-подачу, структурированный контент и визуальный стиль в эстетике aquarium / glassmorphism / deep blue.",
                        "links": [
                            {"label": "GitHub", "url": "https://github.com/f1sherFM/aquarium-portfolio"},
                            {"label": "Подробнее", "url": "https://github.com/f1sherFM/aquarium-portfolio/blob/main/README.md"},
                        ],
                    },
                    {
                        "tag": "Knowledge Base",
                        ...
                        "description": "База знаний Django, подобная той, что используется в производственной среде, для хранения заметок, технических руководств, исправлений ошибок и идей. Включает публичные и приватные заметки, теги, комментарии, голоса, избранное, HTML-интерфейс и API DRF с JWT-аутентификацией.",
                        "links": [
                            {"label": "GitHub", "url": "https://github.com/f1sherFM/knowledge_base"},
                            {"label": "Подробнее", "url": "https://github.com/f1sherFM/knowledge_base/blob/main/README.md"},
                        ],
                    },
                    {
                        "tag": "Blog API",
                        "meta": "Django / DRF / JWT",
                        "title": "Skill Blog",
                        "description": "Учебный, но production-like проект на Django 5.x: веб-интерфейс на шаблонах и REST API на DRF + JWT с акцентом на читаемую архитектуру и корректные права доступа.",
                        "links": [
                            {"label": "GitHub", "url": "https://github.com/f1sherFM/skill-blog-api"},
                            {"label": "Подробнее", "url": "https://github.com/f1sherFM/skill-blog-api/blob/main/README.md"},
                        ],
                    },
                ],
            },
            ...
            "projects": {
                ...
                "items": [
                    ...
                    },
                    {
                        ...
                        "meta": "Django / Analytics / Tracking",
                        "title": "Habit Tracker",
                        "description": "A habit tracking web application with advanced analytics, categorization, and comments.",
                        "links": [
                            {"label": "GitHub", "url": "https://github.com/f1sherFM/Habit-Tracker"},
                            {"label": "Read more", "url": "https://github.com/f1sherFM/Habit-Tracker/blob/main/README.md"},
                        ],
                    },
                    {
                        "tag": "Course Project",
                        "meta": "FastAPI / Docker / Kubernetes",
                        "title": "Bookstore API Course",
                        "description": "A full Python development course: FastAPI, Docker, Kubernetes, Alembic, and DevOps from fundamentals to production with 95% test coverage.",
                        "links": [
                            {"label": "GitHub", "url": "https://github.com/f1sherFM/bookstore-api-course"},
                            {"label": "Read more", "url": "https://github.com/f1sherFM/bookstore-api-course/blob/main/README_RU.md"},
                        ],
                    },
                    {
                        "tag": "Library",
                        "meta": "Python / Validation / Files",
                        "title": "Fishertools",
                        "description": "A Python library that helps handle common errors, validate input data, work safely with files, and explain errors in a beginner-friendly way.",
                        "links": [
                            {"label": "GitHub", "url": "https://github.com/f1sherFM/Fishertools"},
                            {"label": "Read more", "url": "https://github.com/f1sherFM/Fishertools/blob/main/README.md"},
                        ],
                    },
                    {
                        "tag": "Web",
                        "meta": "Django / Templates / CSS",
                        "title": "Aquarium Portfolio",
                        "description": "A personal Django portfolio site focused on backend presentation, structured content, and an aquarium / glassmorphism / deep blue visual style.",
                        "links": [
                            {"label": "GitHub", "url": "https://github.com/f1sherFM/aquarium-portfolio"},
                            {"label": "Read more", "url": "https://github.com/f1sherFM/aquarium-portfolio/blob/main/README.md"},
                        ],
                    },
                    {
                        "tag": "Knowledge Base",
                        "meta": "Django / DRF / JWT",
                        "title": "Knowledge Base",
                        "description": "A Django knowledge base similar to those used in production for notes, technical guides, bug fixes, and ideas. Includes public and private notes, tags, comments, votes, favorites, an HTML interface, and a DRF API with JWT authentication.",
                        "links": [
                            {"label": "GitHub", "url": "https://github.com/f1sherFM/knowledge_base"},
                            {"label": "Read more", "url": "https://github.com/f1sherFM/knowledge_base/blob/main/README.md"},
                        ],
                    },
                    {
                        "tag": "Blog API",
                        "meta": "Django / DRF / JWT",
                        "title": "Skill Blog",
                        "description": "A study project with production-like structure on Django 5.x: template-based web interface plus a DRF + JWT REST API with emphasis on clean architecture and correct permissions.",
                        "links": [
                            {"label": "GitHub", "url": "https://github.com/f1sherFM/skill-blog-api"},
                            {"label": "Read more", "url": "https://github.com/f1sherFM/skill-blog-api/blob/main/README.md"},
                        ],
                    },
                ],
            },
